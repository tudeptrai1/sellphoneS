...
class UserAddressSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('user_addresses')->insert([
            ...
            ['user_id'  => 2, 'order_id' => 111546, 'receive_name' => 'Phạm Hữu Duyên', 'receive_phone' => '+84355390151',
             'province' => 'Thành phố Hà Nội', 'district' => 'Quận Ba Đình', 'ward' => 'Phường Trúc Bạch', 'detail' => '151 Nguyễn Kim'
            ],
            ['user_id'  => 3, 'order_id' => 111547, 'receive_name' => 'Trần Thị Ngọc Truyền', 'receive_phone' => '+84355390151',
             'province' => 'Tỉnh Quãng Ngãi', 'district' => 'Huyện Bình Sơn', 'ward' => 'Xã Bình Thạnh', 'detail' => '246 Lê Lai'
            ],
            ['user_id'  => 4, 'order_id' => 111548, 'receive_name' => 'Phạm Thị Hiểu Ngân', 'receive_phone' => '+84355390151',
