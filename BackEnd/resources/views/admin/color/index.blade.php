...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{route('color.create')}}">  <button class="btn btn-primary shadow-md mr-2">Add New Color</button></a>
            <div class="dropdown">
                ...
                @foreach($data as $each)
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                <a href="{{route('color.edit',$each['id'])}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                    ...
                    <div id="delete-confirmation-modal{{$each['id']}}" class="modal" tabindex="-1" aria-hidden="true">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <form method="post" action="{{route('color.destroy',$each['id'])}}">
                                        @csrf
                                        @method('delete')
